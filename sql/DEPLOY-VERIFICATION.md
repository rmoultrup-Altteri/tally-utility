...
**Current: v5.2.1 + v5.4.0-00 through v5.4.0-06 + v5.4.1-01 + v5.4.1-02 + v5.4.2-01 through v5.4.2-07, verified 2026-08-31.** After v5.4.2-07: **82 tables** / **81 policies** / **80 FORCE-RLS** / **357 CHECKs** / **357 FKs** / **10 EXCLUDE** / **59 UNIQUEs** / **250 triggers (182 ENABLE ALWAYS)** / **571 indexes** / **383 functions**; `has_database_privilege('tally_app', db, 'TEMP') = false`. tu.sql **19,779 lines** (pure appends; anchors 337/3600/3679 intact).
