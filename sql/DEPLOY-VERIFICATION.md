...
**Current: v5.2.1 + v5.4.0-00 through v5.4.0-06 + v5.4.1-01 + v5.4.1-02 + v5.4.2-01 through v5.4.2-06, verified 2026-08-28.** After v5.4.2-06: **79 tables** / **78 policies** / **77 FORCE-RLS** / **344 CHECKs** / 8 EXCLUDE / **237 triggers** (**170 ENABLE ALWAYS**) / 555 indexes / 345 FKs / 56 UNIQUEs; tu.sql **18,822 lines** (pure appends; anchors 337/3600/3679 intact). `tally_app` no longer holds TEMP on the database.
