...
-- ============================================================================
-- MIRROR: PATCH v5.4.0-01 — application role, GRANTs, FORCE ROW LEVEL SECURITY
-- Appended 2026-08-19; source of truth: sql/v5.4.0-01-app-role-and-grants.sql
-- Pure append: every pre-existing line number is unchanged (anchors 337/3600/3679 intact).
-- ============================================================================
...
-- ============================================================================
-- MIRROR: PATCH v5.4.0-02 — meters & reads set (backlog items 1, 2, 8, 9)
-- Appended 2026-08-19; source of truth: sql/v5.4.0-02-meters-and-reads.sql
-- Pure append: every pre-existing line number is unchanged (anchors 337/3600/3679 intact).
-- ============================================================================
--
...
-- ============================================================================
-- MIRROR: PATCH v5.4.0-03 — rating & WNA set (backlog items 4, 5, 6, 7)
-- Appended 2026-08-19; source of truth: sql/v5.4.0-03-rating-and-wna.sql
-- Pure append: every pre-existing line number is unchanged (anchors 337/3600/3679 intact).
-- ============================================================================
...
-- ============================================================================
-- MIRROR: PATCH v5.4.0-04 — programs & lifecycle: A-11 substrate + item 10 (D8-2)
-- Appended 2026-08-19; source of truth: sql/v5.4.0-04-programs-and-lifecycle.sql
-- Pure append: every pre-existing line number is unchanged (anchors 337/3600/3679 intact).
-- ============================================================================
...
-- ============================================================================
-- MIRROR: PATCH v5.4.0-05 — pipeline & events set (backlog items 11, 12, 13)
-- Appended 2026-08-19; source of truth: sql/v5.4.0-05-pipeline-and-events.sql
-- Pure append: every pre-existing line number is unchanged (anchors 337/3600/3679 intact).
-- ============================================================================
...
-- ============================================================================
-- MIRROR: PATCH v5.4.0-06 — PGA set: monthly reconciliation + threshold config (D3D-1)
-- Appended 2026-08-19; source of truth: sql/v5.4.0-06-pga.sql
-- ============================================================================
...
-- ============================================================================
-- MIRROR: PATCH v5.4.1-02 — tenant_configuration_history + time-aware get_partial_period_policy() (Phase 2 item 2.4)
-- Appended 2026-08-20; source of truth: sql/v5.4.1-02-tenant-configuration-history.sql
-- ============================================================================
--
...
-- ============================================================================
-- MIRROR: PATCH v5.4.2-01 — bill immutability, append-only ledger, no hard deletes (Phase 4 Wave 1, A-4)
-- Appended 2026-08-20; source of truth: sql/v5.4.2-01-immutability-and-append-only.sql
-- ============================================================================
...
$$;
-- ============================================================================
-- MIRROR: PATCH v5.4.2-02 — A-4 follow-up: void_invoice() hardened, direct-void gated, guards ENABLE ALWAYS
-- Appended 2026-08-20; source of truth: sql/v5.4.2-02-a4-followup.sql
-- ============================================================================
...
$$;
-- ============================================================================
-- MIRROR: PATCH v5.4.2-03 — A-1: bi-temporal transaction-time substrate for the seven reference tables (Phase 4 Wave 1; CI-001/002/005/011)
-- Appended 2026-08-28; source of truth: sql/v5.4.2-03-bitemporal-substrate.sql
-- ============================================================================
...
$$;
-- ============================================================================
-- MIRROR: PATCH v5.4.2-04 — A-3: invoice calculation snapshots, Option B (Phase 4 Wave 1; CI-015)
-- Appended 2026-08-28; source of truth: sql/v5.4.2-04-invoice-calculation-snapshots.sql
-- ============================================================================
...
-- ============================================================================
-- MIRROR: PATCH v5.4.2-05 — A-20: read/bill exception queue and validation-state substrate (Phase 4 Wave 2; CI-112/113/115/023)
-- Appended 2026-08-28; source of truth: sql/v5.4.2-05-read-and-bill-exception-substrate.sql
-- ============================================================================
...
-- ============================================================================
-- MIRROR: PATCH v5.4.2-06 — A-21: account lifecycle state-events, date-effective account attributes, deposit / interest ledger (Phase 4 Wave 2; CI-121/125/129/130/131)
-- Appended 2026-08-28; source of truth: sql/v5.4.2-06-account-lifecycle-and-deposits.sql
-- ============================================================================
