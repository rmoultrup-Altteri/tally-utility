...
SET ROLE tally_app;
DELETE FROM public.invoice_calculation_snapshots WHERE invoice_id = '00000000-0000-4000-8000-00000000f102';
...
VALUES ('00000000-0000-4000-8000-00000000fa01','00000000-0000-4000-8000-00000000f102','00000000-0000-4000-8000-00000000f002','2025-06-30',now(),'v1','race',
 ...
 '[{"invoice_line_item_id":"00000000-0000-4000-8000-00000000f202","charge_type":"base_charge","amount":12.50}]');
SELECT 'A holding' AS a, clock_timestamp();
SELECT pg_sleep(4);
COMMIT;
